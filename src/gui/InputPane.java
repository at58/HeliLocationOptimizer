...
/**
 * The input pane is the main panel for all gui elements that receiving user
 * inputs, such as text fields or the data table. The {@link DataPanel} is
 * nested in this pane.
 */
public class InputPane extends JPanel {

	private static final long serialVersionUID = 4188489266750450884L;
	...
	public InputPane(Point alignment) {
		...
		this.lblNoTableDataErrMsg = new JLabel(
				"<html>Die Unfalldaten-Tabelle ist leer!" + "<br>Importieren oder tragen Sie Daten ein.");
		...
		this.lblInvalidTableInputErrMsg = new JLabel("<html>Der eingegebene Datensatz ist ungueltig! "
				+ "Achten Sie auf komplette Eingaben und " + "ganze Zahlen ohne Komma.");
		...
		lblIncompatibleColumnErrMsg = new JLabel(
				"<html>Import fehlgeschlagen! Die Spalten der " + "importierten Datei sind inkompatibel.");
		...
		lblNumberFormatErrMsg = new JLabel(
				"<html>Import fehlgeschlagen! In eine oder mehrere " + "Zahlenwert-Spalten der importierten Datei sind "
