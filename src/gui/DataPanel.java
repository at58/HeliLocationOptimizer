...
/**
 * The data panel is a gui element that contains all elements of the data table.
 * The {@link TablePanel} is nested into the data panel. The data panel itself
 * is nested in {@link InputPane}.
 */
public class DataPanel extends JPanel {

	private static final long serialVersionUID = -6446732152976071581L;
	...
	public DataPanel() {
		...
		txtTupleInputs = new JTextField[] { txtLocation, txtX_Coordinate, txtY_Coordinate, txtAccidents };
		...
		Button btnConfirmInput = new Button("  +  ", Color.GREEN, Color.BLACK, Font.CONSOLAS16,
				"Den eingegebenen Datensatz hinzufuegen.", new Point(), new Dimension(), action -> {
