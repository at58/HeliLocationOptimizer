...
/**
 * The main controller is responsible for any user inputs via the user interface
 * clicks, especially for the button actions.
 */
public class MainController {

	private static final CsvParser csvParser = new CsvParser();
	private static GUI gui;
	private static List<Helicopter> helicopterList;
	...
	public static void calculate() {
		...
		if (helicopterList.isEmpty()) {
			...
			JOptionPane.showMessageDialog(gui, "Berechnung erfolgreich abgeschlossen!" + System.lineSeparator()
					+ "Optimale Helikopter-Standorte wurden auf der Karte eingezeichnet." + System.lineSeparator()
					+ "Eine CSV-Datei mit den Ergebnis-Details kann heruntergeladen werden.",
					"Berechnung abgeschlossen", JOptionPane.INFORMATION_MESSAGE);
			gui.showSolution(helicopterList);
		}
	}
	...
	/**
	 * Export of the solution containing detailed information about the optimum
	 * placements of helicopters.
	 */
	public static void exportSolution() {
		CsvExporter.saveSolution(helicopterList);
	}
